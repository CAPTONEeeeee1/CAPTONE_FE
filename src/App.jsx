...
      '/workspaces/:workspaceId/chat', // Thêm Chat Route pattern
      '/reports/:workspaceId',
    ];
...
        {/* Giữ cách viết ngắn gọn cho PublicRoute nếu không có logic phức tạp */}
...
      {/* Dữ liệu logic hiện tại không sử dụng loadingWorkspace và isWorkspacePremium để bọc Route */}
    </>
  );
}